...
const BASE_URL = "https://kanbas-node-server-app-gucen.onrender.com/api";

export const getAssignments = async (courseId) => {
    const response = await axios.get(`https://kanbas-node-server-app-gucen.onrender.com/api/courses/${courseId}/assignments`);
...
export const deleteAssignment = async (assignmentId) => {
    const response = await axios.delete(`https://kanbas-node-server-app-gucen.onrender.com/api/assignments/${assignmentId}`);
    return response.data;
};
