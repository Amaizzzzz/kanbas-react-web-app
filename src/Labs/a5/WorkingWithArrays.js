...
function WorkingWithArrays() {
    ...
    const API = "http://kanbas-node-server-app-gucen.onrender.com/a5/todos";
    ...
    const createNewTodo = async () => {
      ...
      const updateDescription = async (id) => {
        try {
            await axios.patch(`http://kanbas-node-server-app-gucen.onrender.com/todos/${id}/description`, { description });
            // Handle success
        } catch (error) {
            // Handle error
        }
    ...
    const updateCompleted = async (id) => {
        try {
            await axios.patch(`http://kanbas-node-server-app-gucen.onrender.com/todos/${id}/completed`, { completed });
            // Handle success
        } catch (error) {
            // Handle error
        }
