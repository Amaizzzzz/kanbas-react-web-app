...
function WorkingWithObjects() {
    ...
    const URL = 'http://kanbas-node-server-app-gucen.onrender.com/a5/assignment'; // Base URL for API requests
    ...
    return (
        <div>
            ...
            <a href="http://kanbas-node-server-app-gucen.onrender.com/a5/assignment" className="btn btn-primary me-2">
                Get Assignment
            </a>

            <h4>Retrieving Properties</h4> {/* Subtitle for retrieving specific properties */}
            {/* Link to get the title of the assignment */}
            <a href="http://kanbas-node-server-app-gucen.onrender.com/a5/assignment/title" className="btn btn-primary me-2">
                Get Title
            </a>
        </div>
    );
